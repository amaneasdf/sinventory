                ...
                Select Case inlap_type
                    ...
                    Case "p_salesbayartanggal"
                        ...
                        inquery = "SELECT p_bayar_sales as psb_sales, salesman_nama as psb_sales_n, p_bayar_tanggal_bayar as psb_tgl, " _
                            & "sum(p_trans_nilaibayar) as psb_total " _
                            ...
                            & "GROUP BY p_bayar_tanggal_bayar, p_bayar_sales"
                    ...
                    Case "p_salesglobal"
                        ...
                        inquery = "SELECT salesman_nama as psg_sales_n, COUNT(faktur_kode) as psg_jlFak, " _
